...
public class RealTrainModUnofficial {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MAIN_TAB =
        CREATIVE_MODE_TABS.register("main_tab", () -> CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0)
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> RTMU_TAB =
        CREATIVE_MODE_TABS.register("rtmu_tab", () -> CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0)
    ...
    public RealTrainModUnofficial(IEventBus modEventBus, ModContainer modContainer, Dist dist) {
        ...
        // ★Fabric のシム (ShimEventBus) は型消去で引数からイベント型を割り出せないので、
        // かならず addListener(Class, Consumer) を使う。1 引数版は実行時に落ちる。
        ...
        modEventBus.addListener(net.neoforged.neoforge.common.world.chunk.RegisterTicketControllersEvent.class,
            event -> event.register(com.portofino.realtrainmodunofficial.world.TrainChunkLoader.CONTROLLER));
        ...
        net.neoforged.neoforge.common.NeoForge.EVENT_BUS.addListener(
            ...
            e -> com.portofino.realtrainmodunofficial.installedobject.SpeakerSoundConfig.load());
        net.neoforged.neoforge.common.NeoForge.EVENT_BUS.addListener(
